...
## How this ties to the rest of the namespace

You cannot use a certificate well without the concepts in `sailing.basics`. Wind direction, apparent wind, and points of sail show up in both the theory exam and on the water.
